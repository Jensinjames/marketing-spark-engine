    ...
    <AuthGuard requireAuth={true}>
      <Layout>
        <div className="max-w-4xl mx-auto">
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p id={`${type.id}-description`} className="text-sm text-gray-600 mt-1">
                          {type.description}
                        </p>
          ...
          {/* Generation Form */}
          {selectedType && (
            <section aria-labelledby="generation-form-heading">
              <Card>
                <CardHeader>
                ...
                <CardContent className="space-y-6">
                  <form onSubmit={(e) => { e.preventDefault(); handleGenerate(); }} className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="content-prompt"
                        placeholder="Describe what you want to create, your target audience, key messages, tone of voice, etc."
                        value={prompt}
