    ...
    <div className="mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {assetTypes.map((asset, index) => (
          <Card key={index} className={`border-2 ${asset.borderColor} hover:shadow-lg transition-all duration-300 cursor-pointer group relative overflow-hidden`}>
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-xl font-semibold text-gray-900">{asset.title}</CardTitle>
              <CardDescription className="text-gray-600 text-base">{asset.description}</CardDescription>
            </CardHeader>
            <CardContent className="pt-0">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-500 font-medium">{asset.credits} credits</span>
