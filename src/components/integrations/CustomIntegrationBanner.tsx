...
const CustomIntegrationBanner = () => {
  return (
    <section 
      ...
      aria-labelledby="custom-integration-title"
      role="region"
    >
      <div className="text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            variant="secondary" 
            className="bg-white text-purple-600 hover:bg-gray-100 font-medium focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-purple-600"
            aria-describedby="request-integration-description"
          >
            Request Integration
          </Button>
          ...
          <Button 
            variant="outline" 
            className="border-white/30 text-white hover:bg-white/10 font-medium focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-purple-600"
