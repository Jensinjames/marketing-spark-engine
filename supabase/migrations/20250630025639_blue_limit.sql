-- Migration to fix infinite recursion in profiles table policies
-- and resolve authentication/authorization issues
...
-- Recreate plan_features policies (drop first to ensure clean state)
