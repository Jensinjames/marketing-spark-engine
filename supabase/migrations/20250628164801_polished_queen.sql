/*
  # Database Security and RLS Policy Setup
  ...
  2. Team Management
    - Policies for team ownership and membership
    - Credit management for team members
...
-- Handle the reset_monthly_credits function conflict by dropping and recreating
